...
import { CreateRoleData } from "modules/create_role/CreateRoleData";
import { CreateRoleView  } from "modules/create_role/CreateRoleView";
import { OpenDataView } from "modules/open_data_context/OpenDataView";
...
export class LoginView extends BaseView {
    ...
    InitData() {
        ...
        self.AddSmartDataCare(CreateRoleData.Inst().FinishCreateData, self.isFinishCreate.bind(self), "isFinishSign");
    }
    ...
    private onRoleData() {
        let readyChcek = () => {
            return ViewManager.Inst().commonPkgLoaded &&
                ViewManager.Inst().IsOpened(MainView) &&
