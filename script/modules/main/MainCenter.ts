...
export class MainCenter extends fgui.GComponent {
    ...
    private FlushAttrShow() {
        ...
        this.viewNode.Attrs.SetData(attrs1);
        this.viewNode.Attrs2.SetData(attrs2);
    }
    ...
    private FlushEquip1Show() {
        ...
        if (this.equip_list_data) {
            ...
            this.viewNode.Equips1.SetData(BagData.Inst().GetEquipmentItemList());
        }
    ...
    private FlushEquip2Show() {
        ...
        this.viewNode.Equips2.SetData(list2);
