...
@BaseView.registView 
export class StarMapEnterView extends BaseView {
    protected viewRegcfg:viewRegcfg = {
        UIPackName: "StarMap",
        ViewName: "StarMapEnter",
        LayerType: ViewLayer.Normal,
        ViewMask: ViewMask.BgBlockClose
    };

    protected extendsCfg = [
        { ResName: "StarMapEnterAttr", ExtendsClass: StarMapEnterAttr },
    ];
    ...
    InitData() {
        ...
        let param = StarMapData.Inst().GetEnterParam();
        ...
        GuideCtrl.Inst().AddGuideUi("StarMapEnterBtnEnter", this.viewNode.BtnEnter);
    }

    private CloseView(){
        ViewManager.Inst().CloseView(StarMapEnterView)
    }
...
export class StarMapEnterAttr extends fgui.GComponent {
    private viewNode = {
