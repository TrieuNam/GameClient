...
export class DungeonData extends DataBase{
    ...
    constructor() {
        ...
        this.chief_info = {}
        this.chief_info.stage_1 = { stage: 1, pass_level: 0, sweep_count: 0 }
        this.chief_info.stage_2 = { stage: 2, pass_level: 0, sweep_count: 0 }
        this.chief_info.stage_3 = { stage: 3, pass_level: 0, sweep_count: 0 }
        this.reded = false
    }
    ...
    public SetSCLingZhuInfo(data: PB_SCLingZhuInfo){
        ...
        // Guard: empty list means new player with no dungeon records - nothing to update
